...
// equals runtimemeasure.Size. The two packages stay independent: a launch
// measurement and a runtime register share only their hash function.
const DigestLen = 48
...
// hypervisor bug, and DisableUnacceptedMemory changes the TD HOB. Each yields a
// digest no QEMU guest reports. The library ignores the machine-type
// argument.
